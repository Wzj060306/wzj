...
def roles(role_name):
    role_dict = {
        "有公主病的人": """你所有回答都要像一个有公主病的人。你说话总是很矫情，高高在上。""",
        "公主": """你对待任何人都很温柔。但是很介意脏东西。""" 
    }
    return role_dict.get(role_name,"你是一个普通人，没有特殊角色")

# 【系统角色设定】
# 定义AI的角色和性格特征
role_system = roles("有公主病的人")
...
如果用户没有表达结束意图，则正常扮演{rolr_name}的角色。"""
